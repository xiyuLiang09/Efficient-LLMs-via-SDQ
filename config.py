...
Config.lora_bits_configs = {
    ...
    "lora_4_6": {"r": 32, "lora_alpha": 64, "lora_dropout": 0.05},  # alpha = [16, 32]
    "lora_4_8": {"r": 16, "lora_alpha": 32, "lora_dropout": 0.05},  # alpha = [16, 32]
    "lora_4_16": {"r": 8, "lora_alpha": 32, "lora_dropout": 0.08},  # alpha = [4, 8, 16, 32]
...
Config.bits_config_list = [
    ...
    {
        "default": {"attn": {"w_bits": 4, "a_bits": 8, "kv_bits": 16}, "mlp": {"w_bits": 4, "a_bits": 8}},
        "layers": {},
    },
    {
        "default": {"attn": {"w_bits": 4, "a_bits": 16, "kv_bits": 16}, "mlp": {"w_bits": 4, "a_bits": 16}},
        "layers": {},
    },
    {
